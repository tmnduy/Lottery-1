...
public class KQXS_Giai3_Adapter extends RecyclerView.Adapter<KQXS_Giai3_Adapter.KQXSHolder> {
    private ArrayList<KQXS_Giai3_Module> ListKQXS;
    ...
    public KQXS_Giai3_Adapter(ArrayList<KQXS_Giai3_Module> listKQXS, Lottery_MN_MT lottery_mn_mt) {
        ListKQXS = listKQXS;
        this.lottery_mn_mt = lottery_mn_mt;
    }

    public KQXS_Giai3_Adapter(ArrayList<KQXS_Giai3_Module> listKQXS, Lottery_MB lottery_mb) {
        ListKQXS = listKQXS;
    ...
    public void onBindViewHolder(@NonNull KQXSHolder holder, int position) {
        final KQXS_Giai3_Module KQXSGiai3_module = ListKQXS.get(position);
        holder.TvGIAITHUONG.setText(KQXSGiai3_module.getGIAITHUONG());
