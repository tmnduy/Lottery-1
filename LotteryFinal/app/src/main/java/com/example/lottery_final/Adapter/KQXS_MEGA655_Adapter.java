...
public class KQXS_MEGA655_Adapter extends RecyclerView.Adapter<KQXS_MEGA655_Adapter.KQXSHolder> {
    ...
    public KQXS_MEGA655_Adapter(ArrayList<KQXS_MEGA655_Module> listKQXS, Lottery_Vietlott655 lottery_vietlott655) {
        ListKQXS = listKQXS;
